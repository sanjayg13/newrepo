...
using namespace std;
/*
	-If a class consists of only parameterized constructors and no 
	 default constructor, then it is a message to the class consumer
	 that they cannot construct objects without input parameter(s).
*/
class CA
{
private:
